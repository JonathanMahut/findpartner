import 'package:findpartner/components/password_text_field.dart';
import 'package:findpartner/components/text_form_builder.dart';
import 'package:findpartner/models/enum/gender_type.dart';
import 'package:findpartner/utils/validation.dart';
import 'package:findpartner/view_models/auth/register_view_model.dart';
import 'package:findpartner/widgets/indicators.dart';
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            Text(
              'Welcome to Find Partnert\nCreate a new account and connect with friends for fun pleasures',
      ...
      child: Column(
        children: [
          ...
          SwitchListTile(
            ...
            title: const Text('We are a Couple'),
            value: false,
            onChanged: (bool? val) {
              setState(() {
                viewModel.setCouple(val);
              });
            },
          ),
